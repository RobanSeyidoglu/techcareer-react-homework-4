    ...
    return (
        <div className="w3-container w3-padding-32" id="contact">
            ...
            <form action="#" target="_blank">
                ...
                <input className="w3-input w3-section w3-border" type="text" placeholder="Subject" required
                       name="Subject"/>
                <input className="w3-input w3-section w3-border" type="text" placeholder="Comment" required
                       name="Comment"/>
